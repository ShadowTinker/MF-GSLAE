...
class MacridDAE33(CrossDomainRecommender, AutoEncoderMixin):
    r"""(30) learnbale mask + linear proj

    """
    input_type = InputType.PAIRWISE

    def __init__(self, config, dataset):
        super(MacridDAE33, self).__init__(config, dataset)
    ...
    def forward(self, source_user=None, target_user=None):
        ...
        if source_user != None:
            ...
            for k in range(self.kfac):
                ...
                h_source = self.linear_proj[k](h_source)
        ...
        if target_user != None:
            ...
            for k in range(self.kfac):
                ...
                h_target = self.linear_proj[k](h_target)
    ...
    def calculate_loss(self, interaction):
        ...
        return (ce_loss_source, ce_loss_target, 0e-3 * mask_reg, self.cov_reg * self.covariance_reg())
