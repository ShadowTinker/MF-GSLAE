...
class MacridDAE27(CrossDomainRecommender, AutoEncoderMixin):
    r"""FFT + loss calculation (18) + Correlated Topic Model

    """
    input_type = InputType.PAIRWISE

    def __init__(self, config, dataset):
        super(MacridDAE27, self).__init__(config, dataset)
