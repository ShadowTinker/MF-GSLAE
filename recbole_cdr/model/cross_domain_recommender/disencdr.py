...
class DisenCDR(CrossDomainRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        self.source_user_embedding = nn.Embedding(self.total_num_users, opt["feature_dim"])
        self.target_user_embedding = nn.Embedding(self.total_num_users, opt["feature_dim"])
        self.source_item_embedding = nn.Embedding(self.total_num_items, opt["feature_dim"])
        self.target_item_embedding = nn.Embedding(self.total_num_items, opt["feature_dim"])
        self.source_user_embedding_share = nn.Embedding(self.total_num_users, opt["feature_dim"])
        self.target_user_embedding_share = nn.Embedding(self.total_num_users, opt["feature_dim"])
...
class singleVBGE(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.encoder.append(SingleLastLayer(opt))
