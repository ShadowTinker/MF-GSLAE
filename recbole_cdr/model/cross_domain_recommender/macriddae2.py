...
class MacridDAE2(CrossDomainRecommender, AutoEncoderMixin):
    ...
    def __init__(self, config, dataset):
        super(MacridDAE2, self).__init__(config, dataset)
    ...
    def calculate_loss(self, interaction):
        ...
        if self.regs[0] != 0 or self.regs[1] != 0:
            return ce_loss_source + ce_loss_target + self.reg_loss()
