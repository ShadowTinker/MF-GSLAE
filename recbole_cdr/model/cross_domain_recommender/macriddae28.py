...
class MacridDAE28(CrossDomainRecommender, AutoEncoderMixin):
    r"""(27) + M \times K intent allocation matrix

    """
    input_type = InputType.PAIRWISE

    def __init__(self, config, dataset):
        super(MacridDAE28, self).__init__(config, dataset)
        ...
        self.cores_mu = nn.Embedding(self.total_num_items, self.kfac)
    ...
    def forward(self, source_user=None, target_user=None):
        ...
        cates_logits = F.normalize(cores) / self.tau
    ...
    def calculate_loss(self, interaction):
        ...
        return (ce_loss_source, ce_loss_target, self.lmd_disen * compactness_loss, self.lmd_disen * reg_loss, self.cov_reg * self.covariance_reg())
