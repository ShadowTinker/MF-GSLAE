...
class MacridDAE29(CrossDomainRecommender, AutoEncoderMixin):
    r"""(18) + divide then project

    """
    input_type = InputType.PAIRWISE

    def __init__(self, config, dataset):
        super(MacridDAE29, self).__init__(config, dataset)
        ...
        #     nn.Linear(self.total_num_items, self.lat_dim),
        #     nn.ReLU(),
        ...
        # self.cores = nn.Embedding(self.total_num_items, self.kfac)
        ...
        self.k_proj = nn.ModuleList([nn.Linear(self.lat_dim, self.lat_dim) for _ in range(self.kfac)])
    ...
    def forward(self, source_user=None, target_user=None):
        ...
        if source_user != None:
            ...
            for k in range(self.kfac):
                ...
                # h_source = self.k_proj[k](h_source)
        ...
        if target_user != None:
            ...
            for k in range(self.kfac):
                ...
                # h_target = self.k_proj[k](h_target)
