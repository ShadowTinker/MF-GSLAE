...
class MacridDAE18(CrossDomainRecommender, AutoEncoderMixin):
    r"""FFT + loss calculation (15) + GSL + compactness

    """
    input_type = InputType.PAIRWISE

    def __init__(self, config, dataset):
        super(MacridDAE18, self).__init__(config, dataset)
    ...
    def forward(self, source_user=None, target_user=None):
        ...
        # cates_logits = F.normalize(self.cores.weight) / self.tau
